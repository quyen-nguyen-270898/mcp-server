...
if __name__ == "__main__":
    ...
    # Get token from environment variable or use hardcoded endpoint
    endpoint_url = os.environ.get('MCP_ENDPOINT') or 'wss://api.xiaozhi.me/mcp/?token=eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjU1MjIyNCwiYWdlbnRJZCI6MTE5NDc1OSwiZW5kcG9pbnRJZCI6ImFnZW50XzExOTQ3NTkiLCJwdXJwb3NlIjoibWNwLWVuZHBvaW50IiwiaWF0IjoxNzY2NTg5NTkzLCJleHAiOjE3OTgxNDcxOTN9.pW7N7UWRlT6NbZ9eZ1BBH9shhz3Jpn2AM_TubeecKRamcb7fKFwTjWjmeIDt-WDMh-xBxFOyhGDuT872o5vZlQ'
    if not endpoint_url:
